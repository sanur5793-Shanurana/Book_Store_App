...
const Navbar = () => {
  ...
  useEffect(()=>{
    ...
    return()=>{
      window.removeEventListener('sccroll',handlescroll)
    }
  },[])
  const NavItem = (<>
    <li><a>Home</a></li>
  ...
  return (
    <>
      <div className={`max-w-screen-2x1 container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 ${sticky?"sticky-navbar shadow-md bg-base-300 duration-300 transition-all ease-in-out":""}`}>
